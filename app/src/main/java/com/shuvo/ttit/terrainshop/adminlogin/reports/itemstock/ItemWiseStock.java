package com.shuvo.ttit.terrainshop.adminlogin.reports.itemstock;
...
import com.shuvo.ttit.terrainshop.adminlogin.reports.itemstock.adapters.ItemWiseStockAdapter;
...
public class ItemWiseStock extends AppCompatActivity implements ItemWiseStockAdapter.ClickedItem {

    RelativeLayout itemStockBar;
    ...
    ItemWiseStockAdapter itemWiseStockAdapter;
    RecyclerView.LayoutManager layoutManager;

    ArrayList<ItemWiseStockList> stockItemLists;
    ArrayList<ItemWiseStockList> filteredList;

    ArrayList<WareHouseQtyList> wareHouseQtyLists;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_wise_stock);
...
// finally change the color
        ...
        itemStockBar = findViewById(R.id.item_wise_stock_action_bar);
        fullLayout = findViewById(R.id.item_wise_stock_design_layout);
        circularProgressIndicator = findViewById(R.id.progress_indicator_item_wise_stock);
        circularProgressIndicator.setVisibility(View.GONE);

        categorySpinner = findViewById(R.id.cat_type_spinner_item_stock);
        subCatSpinner = findViewById(R.id.sub_cat_type_spinner_item_stock);
        subLay = findViewById(R.id.spinner_layout_sub_cat_item_stock);
        subLay.setEnabled(false);

        searchItem = findViewById(R.id.search_item_name_stock_item);
        searchItemLay = findViewById(R.id.search_item_name_lay_stock_item);

        itemView = findViewById(R.id.item_overview_relation_stock_item);
        ...
        categorySpinner.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mTask = new SubCategoryCheck().execute();
            }
        });
        ...
        itemStockBar.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void filter(String text) {
        ...
        filteredList = new ArrayList<>();
        for (ItemWiseStockList item : stockItemLists) {
        ...
        itemWiseStockAdapter.filterList(filteredList);
    }
...
//            }
    ...
    public class Check extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (conn) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ItemWiseStock.this,R.layout.dropdown_menu_popup_item,R.id.drop_down_item,type);

                categorySpinner.setAdapter(arrayAdapter);

                itemWiseStockAdapter = new ItemWiseStockAdapter(stockItemLists, ItemWiseStock.this,ItemWiseStock.this);
                itemView.setAdapter(itemWiseStockAdapter);
                searchItem.setText("");
                ...
                AlertDialog dialog = new AlertDialog.Builder(ItemWiseStock.this)
    ...
    public class SubCategoryCheck extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (conn) {
                ...
                conn = false;
                connected = false;
                subLay.setEnabled(!categoryId.isEmpty() && categoryId != null);
    ...
    public void CategoryData() {
        try {
            ...
            categoryLists.add(new ChoiceList("","..."));
            ...
            while (resultSet.next()) {
                ...
                while (resultSet2.next()) {
                    j++;
                    wareHouseQtyLists.add(new WareHouseQtyList(String.valueOf(j),resultSet2.getString(1),resultSet2.getString(3)));
                }
                resultSet2.close();
                callableStatement1.close();

                stockItemLists.add(new ItemWiseStockList(String.valueOf(i),resultSet.getString(10),resultSet.getString(11),resultSet.getString(4),resultSet.getString(8),resultSet.getString(5),

package com.shuvo.ttit.terrainshop.products.adapters;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductHolder> {
    ...
    public ProductAdapter(ArrayList<ProductList> newArrivalItemLists, Context context, ClickedItem myClickedItem) {
        this.productLists = newArrivalItemLists;
    ...
    public ProductHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ProductHolder(view,myClickedItem);
    }
    ...
    public class ProductHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ProductHolder(@NonNull View itemView, ClickedItem ci) {
            super(itemView);
            ...
            addToCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Products.CartItemCheckProducts();
                }
            });
